...
START:  
        ...
        MVI     A,35            ;MAGIC NUMBER (CENTERS TEXT ON SCREEN)
        CALL    SETCX           ;SET CURSOR X POS
        MVI     A,110           ;MAGIC NUMBER 2 ELECTRIC BOOGALOO!
...
MAPMEM: MVI     A,VID0          ;SPECIFY VRAM PART 1
...
HOME0:  MVI     A,000H          ;SPECIFY TOP OF VRAM
        OUT     SCANREG         ;SET TOP LINE OFFSET TO 00
        RET

HOME1:  MVI     A,CHOME         ;LOAD HOME CHARACTER
        CALL    COUT            ;GOTO THE HOME POSITION
        RET

CLEAR:  MVI     A,CCLEAR        ;LOAD CLEAR CHARACTER
        CALL    COUT            ;CLEAR FROM CURSOR TO END OF SCREEN
        RET

CURON:  MVI     A,CCURON        ;LOAD CURSOR ON CHARACTER
        CALL    COUT            ;TURN THE CURSOR ON
        RET

CUROFF: MVI     A,CCUROFF       ;LOAD CURSOR OFF CHARACTER
        CALL    COUT            ;TURN THE CURSOR OFF
        RET

SETCX:  STA     CURSX           ;SET CURSOR X POS TO A
        RET

SETCY:  STA     CURSY           ;SET CURSOR Y POS TO A
        RET
